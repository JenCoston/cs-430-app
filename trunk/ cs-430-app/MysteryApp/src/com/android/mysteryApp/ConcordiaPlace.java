...
public class ConcordiaPlace extends Activity {
...
//        t.setText(Ambrosia.getAmbrosia().getName());
    ...
    public void explorePlace(View view){
    	showDialog(ChancellorChuck.getChancellorChuck().getDialog(), 2000);
	...
	private void showDialog(String message, int milliseconds)
	{
		...
		coolImage.setImageResource(R.drawable.pm3_head);

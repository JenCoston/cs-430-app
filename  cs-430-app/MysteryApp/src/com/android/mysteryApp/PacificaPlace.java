...
public class PacificaPlace extends Activity {
...
//        t.setText(Ambrosia.getAmbrosia().getName());
    ...
    public void explorePlace(View view){
    	showDialog(PresidentPaul.getPresidentPaul().getDialog(), 3000);
	...
	private void showDialog(String message, int milliseconds)
	{
		...
		coolImage.setImageResource(R.drawable.president1_head);

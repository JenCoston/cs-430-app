...
public class DislexiaPlace extends Activity {
...
//        t.setText(Ambrosia.getAmbrosia().getName());
    ...
    public void explorePlace(View view){
    	showDialog(DictatorDave.getDictatorDave().getDialog(), 3000);
	...
	private void showDialog(String message, int milliseconds)
	{
		...
		coolImage.setImageResource(R.drawable.president2_head);
